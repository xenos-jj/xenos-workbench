...
const DEFAULT_ACHIEVEMENTS = [
  ...
  { id: 'ac-14', icon: 'book', name: '阅读', desc: '读完 1 本书', type: 'book', need: 1 },
...
function renderOverview() {
  ...
  // 图标 SVG
/* v9369：运动环卡图标从「山形折线」改为标准哑铃 dumbbell（与 ICONS.dumbbell 同 path） */
  ...
  page.innerHTML = `
    ...
    <div class="hp-quick">
      ...
      <div class="hp-quick-grid">
        <!-- v9356：副标题文案更新（用户指定）；主名/副名字号与今日概览环卡一致 -->
        <button class="hp-quick-btn hp-qb-sport" data-qr="sport">
          ...
          <span class="hq-text">
            ...
            <small class="hq-sub">慢慢动起来</small>
          </span>
        ...
        <button class="hp-quick-btn hp-qb-money" data-qr="money">
          ...
          <span class="hq-text">
            ...
            <small class="hq-sub">记录一笔支出</small>
          </span>
          <span class="hq-arrow">›</span>
        </button>
        <button class="hp-quick-btn hp-qb-idea" data-qr="idea">
          ...
          <span class="hq-text">
            ...
            <small class="hq-sub">闪现一个灵感</small>
          </span>
          <span class="hq-arrow">›</span>
        </button>
      </div>
...
// ============ looks 模块（v9529：外貌汇总页已移除；仪态/穿搭/妆容/护肤 各为独立页）============
// 保留：默认值 / 加载保存 / 迁移 / 积分 / 周统计工具（供独立页与支线卡使用）。
