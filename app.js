...
function branchIconBook(stroke = '#9C8AC9', fill = '#a99add', line = '#ffffff') {
  ...
  return `<svg class="br-icon-svg" viewBox="0 0 32 32" width="26" height="26" aria-hidden="true">
    <g stroke-linecap="round" stroke-linejoin="round">
      <path d="M7 10c0-1.7 1.4-3 3.1-3h5.9v17H10.1C8.4 24 7 22.8 7 21.1V10z" fill="#F6EFE0" stroke="${stroke}" stroke-width="1.8"/>
      <path d="M25 10c0-1.7-1.4-3-3.1-3H16v17h5.9c1.7 0 3.1-1.2 3.1-2.9V10z" fill="#F1E9FA" stroke="${stroke}" stroke-width="1.8"/>
      <path d="M16 7V24" stroke="${stroke}" stroke-width="2.2"/>
      <circle cx="11.5" cy="14" r="0.8" fill="${stroke}"/>
      <circle cx="20.5" cy="14" r="0.8" fill="${stroke}"/>
      <path d="M11 16.6q1.3 1.3 2.8 0" stroke="${stroke}" stroke-width="1.2" fill="none"/>
    </g>
  </svg>`;
}
