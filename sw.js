...
const CACHE = 'xenos-cache-v9525';
const STATIC = [
  './',
  'index.html',
  'app.js?v=525',
  'styles.css?v=525',
  'fonts/zcool-sub.ttf?v=525',
  'fonts/strawberry-sub.ttf?v=525',
  'manifest.webmanifest?v=525',
  'icon-192.png?v=525',
  'modules/study.js?v=525',
  'modules/contentlib.js?v=525'
];
