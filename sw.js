...
const CACHE = 'xenos-cache-v9387';
const STATIC = [
  './',
  'index.html',
  'app.js?v=387',
  'styles.css?v=387',
  'fonts/zcool-sub.ttf?v=387',
  'fonts/strawberry-sub.ttf?v=387',
  'assets/mascot.png',
  'manifest.webmanifest?v=387',
  'icon-192.png?v=387',
  'modules/study.js?v=387',
  'modules/contentlib.js?v=387'
];
