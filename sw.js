...
const CACHE = 'xenos-cache-v9386';
const STATIC = [
  './',
  'index.html',
  'app.js?v=386',
  'styles.css?v=386',
  'fonts/zcool-sub.ttf?v=386',
  'fonts/strawberry-sub.ttf?v=386',
  'assets/mascot.png',
  'manifest.webmanifest?v=386',
  'icon-192.png?v=386',
  'modules/study.js?v=386',
  'modules/contentlib.js?v=386'
];
