...
const CACHE = 'xenos-cache-v9555';
const STATIC = [
  './',
  'index.html',
  'app.js?v=555',
  'styles.css?v=555',
  'fonts/zcool-sub.ttf?v=555',
  'fonts/strawberry-sub.ttf?v=555',
  'manifest.webmanifest?v=555',
  'icon-192.png?v=555',
  'modules/study.js?v=555',
  'modules/contentlib.js?v=555'
];
