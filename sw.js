...
const CACHE = 'xenos-cache-v9424';
const STATIC = [
  './',
  'index.html',
  'app.js?v=424',
  'styles.css?v=424',
  'fonts/zcool-sub.ttf?v=424',
  'fonts/strawberry-sub.ttf?v=424',
  'manifest.webmanifest?v=424',
  'icon-192.png?v=424',
  'modules/study.js?v=424',
  'modules/contentlib.js?v=424'
];
