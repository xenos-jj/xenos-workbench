...
const CACHE = 'xenos-cache-v9390';
const STATIC = [
  './',
  'index.html',
  'app.js?v=390',
  'styles.css?v=390',
  'fonts/zcool-sub.ttf?v=390',
  'fonts/strawberry-sub.ttf?v=390',
  'assets/mascot.png',
  'manifest.webmanifest?v=390',
  'icon-192.png?v=390',
  'modules/study.js?v=390',
  'modules/contentlib.js?v=390'
];
