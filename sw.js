...
const CACHE = 'xenos-cache-v9348';
const STATIC = [
  './',
  'index.html',
  'app.js?v=348',
  'styles.css?v=348',
  'fonts/zcool-sub.ttf?v=348',
  'fonts/strawberry-sub.ttf?v=348',
  'assets/mascot.png',
  'manifest.webmanifest?v=348',
  'icon-192.png?v=348',
  'modules/study.js?v=348',
  'modules/contentlib.js?v=348'
];
