...
const CACHE = 'xenos-cache-v9336';
const STATIC = [
  './',
  'index.html',
  'app.js?v=336',
  'styles.css?v=336',
  'fonts/zcool-sub.ttf?v=336',
  'fonts/strawberry-sub.ttf?v=336',
  'assets/mascot.png',
  'manifest.webmanifest?v=336',
  'icon-192.png?v=336',
  'modules/study.js?v=336',
  'modules/contentlib.js?v=336'
];
