...
const CACHE = 'xenos-cache-v9443';
const STATIC = [
  './',
  'index.html',
  'app.js?v=443',
  'styles.css?v=443',
  'fonts/zcool-sub.ttf?v=443',
  'fonts/strawberry-sub.ttf?v=443',
  'manifest.webmanifest?v=443',
  'icon-192.png?v=443',
  'modules/study.js?v=443',
  'modules/contentlib.js?v=443'
];
