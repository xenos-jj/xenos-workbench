...
const CACHE = 'xenos-cache-v9554';
const STATIC = [
  './',
  'index.html',
  'app.js?v=554',
  'styles.css?v=554',
  'fonts/zcool-sub.ttf?v=554',
  'fonts/strawberry-sub.ttf?v=554',
  'manifest.webmanifest?v=554',
  'icon-192.png?v=554',
  'modules/study.js?v=554',
  'modules/contentlib.js?v=554'
];
