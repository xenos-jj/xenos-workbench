...
const CACHE = 'xenos-cache-v9460';
const STATIC = [
  './',
  'index.html',
  'app.js?v=460',
  'styles.css?v=460',
  'fonts/zcool-sub.ttf?v=460',
  'fonts/strawberry-sub.ttf?v=460',
  'manifest.webmanifest?v=460',
  'icon-192.png?v=460',
  'modules/study.js?v=460',
  'modules/contentlib.js?v=460'
];
