...
const CACHE = 'xenos-cache-v9434';
const STATIC = [
  './',
  'index.html',
  'app.js?v=434',
  'styles.css?v=434',
  'fonts/zcool-sub.ttf?v=434',
  'fonts/strawberry-sub.ttf?v=434',
  'manifest.webmanifest?v=434',
  'icon-192.png?v=434',
  'modules/study.js?v=434',
  'modules/contentlib.js?v=434'
];
