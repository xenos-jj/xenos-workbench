...
const CACHE = 'xenos-cache-v9325';
const STATIC = [
  './',
  'index.html',
  'app.js?v=325',
  'styles.css?v=325',
  'fonts/zcool-sub.ttf?v=325',
  'fonts/strawberry-sub.ttf?v=325',
  'assets/mascot.png',
  'manifest.webmanifest?v=325',
  'icon-192.png?v=325',
  'modules/study.js?v=325',
  'modules/contentlib.js?v=325'
];
