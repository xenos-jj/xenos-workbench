...
const CACHE = 'xenos-cache-v9339';
const STATIC = [
  './',
  'index.html',
  'app.js?v=339',
  'styles.css?v=339',
  'fonts/zcool-sub.ttf?v=339',
  'fonts/strawberry-sub.ttf?v=339',
  'assets/mascot.png',
  'manifest.webmanifest?v=339',
  'icon-192.png?v=339',
  'modules/study.js?v=339',
  'modules/contentlib.js?v=339'
];
