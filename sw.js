...
const CACHE = 'xenos-cache-v9406';
const STATIC = [
  './',
  'index.html',
  'app.js?v=406',
  'styles.css?v=406',
  'fonts/zcool-sub.ttf?v=406',
  'fonts/strawberry-sub.ttf?v=406',
  'manifest.webmanifest?v=406',
  'icon-192.png?v=406',
  'modules/study.js?v=406',
  'modules/contentlib.js?v=406'
];
