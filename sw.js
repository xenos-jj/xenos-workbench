...
const CACHE = 'xenos-cache-v9448';
const STATIC = [
  './',
  'index.html',
  'app.js?v=448',
  'styles.css?v=448',
  'fonts/zcool-sub.ttf?v=448',
  'fonts/strawberry-sub.ttf?v=448',
  'manifest.webmanifest?v=448',
  'icon-192.png?v=448',
  'modules/study.js?v=448',
  'modules/contentlib.js?v=448'
];
