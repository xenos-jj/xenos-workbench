...
const CACHE = 'xenos-cache-v9414';
const STATIC = [
  './',
  'index.html',
  'app.js?v=414',
  'styles.css?v=414',
  'fonts/zcool-sub.ttf?v=414',
  'fonts/strawberry-sub.ttf?v=414',
  'manifest.webmanifest?v=414',
  'icon-192.png?v=414',
  'modules/study.js?v=414',
  'modules/contentlib.js?v=414'
];
