...
const CACHE = 'xenos-cache-v9308';
const STATIC = [
  './',
  'index.html',
  'app.js?v=308',
  'styles.css?v=308',
  'fonts/zcool-sub.ttf?v=308',
  'fonts/strawberry-sub.ttf?v=308',
  'assets/mascot.png',
  'manifest.webmanifest?v=308',
  'icon-192.png?v=308',
  'modules/study.js?v=308',
  'modules/contentlib.js?v=308'
];
