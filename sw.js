...
const CACHE = 'xenos-cache-v9522';
const STATIC = [
  './',
  'index.html',
  'app.js?v=522',
  'styles.css?v=522',
  'fonts/zcool-sub.ttf?v=522',
  'fonts/strawberry-sub.ttf?v=522',
  'manifest.webmanifest?v=522',
  'icon-192.png?v=522',
  'modules/study.js?v=522',
  'modules/contentlib.js?v=522'
];
