...
const CACHE = 'xenos-cache-v9312';
const STATIC = [
  './',
  'index.html',
  'app.js?v=312',
  'styles.css?v=312',
  'fonts/zcool-sub.ttf?v=312',
  'fonts/strawberry-sub.ttf?v=312',
  'assets/mascot.png',
  'manifest.webmanifest?v=312',
  'icon-192.png?v=312',
  'modules/study.js?v=312',
  'modules/contentlib.js?v=312'
];
