...
const CACHE = 'xenos-cache-v9358';
const STATIC = [
  './',
  'index.html',
  'app.js?v=358',
  'styles.css?v=358',
  'fonts/zcool-sub.ttf?v=358',
  'fonts/strawberry-sub.ttf?v=358',
  'assets/mascot.png',
  'manifest.webmanifest?v=358',
  'icon-192.png?v=358',
  'modules/study.js?v=358',
  'modules/contentlib.js?v=358'
];
