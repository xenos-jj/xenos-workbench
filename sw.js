...
const CACHE = 'xenos-cache-v9587';
const STATIC = [
  './',
  'index.html',
  'app.js?v=9587',
  'styles.css?v=9587',
  'fonts/zcool-sub.ttf?v=9587',
  'fonts/strawberry-sub.ttf?v=9587',
  'manifest.webmanifest?v=9587',
  'icon-192.png?v=9587',
  'modules/study.js?v=9587',
  'modules/contentlib.js?v=9587'
];
