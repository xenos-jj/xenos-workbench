...
const CACHE = 'xenos-cache-v9388';
const STATIC = [
  './',
  'index.html',
  'app.js?v=388',
  'styles.css?v=388',
  'fonts/zcool-sub.ttf?v=388',
  'fonts/strawberry-sub.ttf?v=388',
  'assets/mascot.png',
  'manifest.webmanifest?v=388',
  'icon-192.png?v=388',
  'modules/study.js?v=388',
  'modules/contentlib.js?v=388'
];
