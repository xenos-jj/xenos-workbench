...
const CACHE = 'xenos-cache-v9326';
const STATIC = [
  './',
  'index.html',
  'app.js?v=326',
  'styles.css?v=326',
  'fonts/zcool-sub.ttf?v=326',
  'fonts/strawberry-sub.ttf?v=326',
  'assets/mascot.png',
  'manifest.webmanifest?v=326',
  'icon-192.png?v=326',
  'modules/study.js?v=326',
  'modules/contentlib.js?v=326'
];
