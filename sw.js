...
const CACHE = 'xenos-cache-v9316';
const STATIC = [
  './',
  'index.html',
  'app.js?v=316',
  'styles.css?v=316',
  'fonts/zcool-sub.ttf?v=316',
  'fonts/strawberry-sub.ttf?v=316',
  'assets/mascot.png',
  'manifest.webmanifest?v=316',
  'icon-192.png?v=316',
  'modules/study.js?v=316',
  'modules/contentlib.js?v=316'
];
