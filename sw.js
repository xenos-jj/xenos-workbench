...
const CACHE = 'xenos-cache-v9427';
const STATIC = [
  './',
  'index.html',
  'app.js?v=427',
  'styles.css?v=427',
  'fonts/zcool-sub.ttf?v=427',
  'fonts/strawberry-sub.ttf?v=427',
  'manifest.webmanifest?v=427',
  'icon-192.png?v=427',
  'modules/study.js?v=427',
  'modules/contentlib.js?v=427'
];
