...
const CACHE = 'xenos-cache-v9441';
const STATIC = [
  './',
  'index.html',
  'app.js?v=441',
  'styles.css?v=441',
  'fonts/zcool-sub.ttf?v=441',
  'fonts/strawberry-sub.ttf?v=441',
  'manifest.webmanifest?v=441',
  'icon-192.png?v=441',
  'modules/study.js?v=441',
  'modules/contentlib.js?v=441'
];
