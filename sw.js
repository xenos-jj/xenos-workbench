...
const CACHE = 'xenos-cache-v9403';
const STATIC = [
  './',
  'index.html',
  'app.js?v=403',
  'styles.css?v=403',
  'fonts/zcool-sub.ttf?v=403',
  'fonts/strawberry-sub.ttf?v=403',
  'manifest.webmanifest?v=403',
  'icon-192.png?v=403',
  'modules/study.js?v=403',
  'modules/contentlib.js?v=403'
];
