...
const CACHE = 'xenos-cache-v9592';
const STATIC = [
  './',
  'index.html',
  'app.js?v=9592',
  'styles.css?v=9592',
  'fonts/zcool-sub.ttf?v=9592',
  'fonts/strawberry-sub.ttf?v=9592',
  'manifest.webmanifest?v=9592',
  'icon-192.png?v=9592',
  'modules/study.js?v=9592',
  'modules/contentlib.js?v=9592'
];
