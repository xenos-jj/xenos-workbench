...
const CACHE = 'xenos-cache-v9309';
const STATIC = [
  './',
  'index.html',
  'app.js?v=309',
  'styles.css?v=309',
  'fonts/zcool-sub.ttf?v=309',
  'fonts/strawberry-sub.ttf?v=309',
  'assets/mascot.png',
  'manifest.webmanifest?v=309',
  'icon-192.png?v=309',
  'modules/study.js?v=309',
  'modules/contentlib.js?v=309'
];
