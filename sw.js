...
const CACHE = 'xenos-cache-v9438';
const STATIC = [
  './',
  'index.html',
  'app.js?v=438',
  'styles.css?v=438',
  'fonts/zcool-sub.ttf?v=438',
  'fonts/strawberry-sub.ttf?v=438',
  'manifest.webmanifest?v=438',
  'icon-192.png?v=438',
  'modules/study.js?v=438',
  'modules/contentlib.js?v=438'
];
