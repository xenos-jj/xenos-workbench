...
const CACHE = 'xenos-cache-v9393';
const STATIC = [
  './',
  'index.html',
  'app.js?v=393',
  'styles.css?v=393',
  'fonts/zcool-sub.ttf?v=393',
  'fonts/strawberry-sub.ttf?v=393',
  'manifest.webmanifest?v=393',
  'icon-192.png?v=393',
  'modules/study.js?v=393',
  'modules/contentlib.js?v=393'
];
