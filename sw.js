...
const CACHE = 'xenos-cache-v9584';
const STATIC = [
  './',
  'index.html',
  'app.js?v=9584',
  'styles.css?v=9584',
  'fonts/zcool-sub.ttf?v=9584',
  'fonts/strawberry-sub.ttf?v=9584',
  'manifest.webmanifest?v=9584',
  'icon-192.png?v=9584',
  'modules/study.js?v=9584',
  'modules/contentlib.js?v=9584'
];
