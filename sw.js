...
const CACHE = 'xenos-cache-v9518';
const STATIC = [
  './',
  'index.html',
  'app.js?v=518',
  'styles.css?v=518',
  'fonts/zcool-sub.ttf?v=518',
  'fonts/strawberry-sub.ttf?v=518',
  'manifest.webmanifest?v=518',
  'icon-192.png?v=518',
  'modules/study.js?v=518',
  'modules/contentlib.js?v=518'
];
