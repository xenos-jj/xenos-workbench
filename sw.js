...
const CACHE = 'xenos-cache-v9383';
const STATIC = [
  './',
  'index.html',
  'app.js?v=383',
  'styles.css?v=383',
  'fonts/zcool-sub.ttf?v=383',
  'fonts/strawberry-sub.ttf?v=383',
  'assets/mascot.png',
  'manifest.webmanifest?v=383',
  'icon-192.png?v=383',
  'modules/study.js?v=383',
  'modules/contentlib.js?v=383'
];
