...
const CACHE = 'xenos-cache-v9322';
const STATIC = [
  './',
  'index.html',
  'app.js?v=322',
  'styles.css?v=322',
  'fonts/zcool-sub.ttf?v=322',
  'fonts/strawberry-sub.ttf?v=322',
  'assets/mascot.png',
  'manifest.webmanifest?v=322',
  'icon-192.png?v=322',
  'modules/study.js?v=322',
  'modules/contentlib.js?v=322'
];
