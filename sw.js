...
const CACHE = 'xenos-cache-v9323';
const STATIC = [
  './',
  'index.html',
  'app.js?v=323',
  'styles.css?v=323',
  'fonts/zcool-sub.ttf?v=323',
  'fonts/strawberry-sub.ttf?v=323',
  'assets/mascot.png',
  'manifest.webmanifest?v=323',
  'icon-192.png?v=323',
  'modules/study.js?v=323',
  'modules/contentlib.js?v=323'
];
