...
const CACHE = 'xenos-cache-v9407';
const STATIC = [
  './',
  'index.html',
  'app.js?v=407',
  'styles.css?v=407',
  'fonts/zcool-sub.ttf?v=407',
  'fonts/strawberry-sub.ttf?v=407',
  'manifest.webmanifest?v=407',
  'icon-192.png?v=407',
  'modules/study.js?v=407',
  'modules/contentlib.js?v=407'
];
