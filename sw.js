...
const CACHE = 'xenos-cache-v9582';
const STATIC = [
  './',
  'index.html',
  'app.js?v=9582',
  'styles.css?v=9582',
  'fonts/zcool-sub.ttf?v=9582',
  'fonts/strawberry-sub.ttf?v=9582',
  'manifest.webmanifest?v=9582',
  'icon-192.png?v=9582',
  'modules/study.js?v=9582',
  'modules/contentlib.js?v=9582'
];
