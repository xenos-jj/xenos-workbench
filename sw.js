...
const CACHE = 'xenos-cache-v9349';
const STATIC = [
  './',
  'index.html',
  'app.js?v=349',
  'styles.css?v=349',
  'fonts/zcool-sub.ttf?v=349',
  'fonts/strawberry-sub.ttf?v=349',
  'assets/mascot.png',
  'manifest.webmanifest?v=349',
  'icon-192.png?v=349',
  'modules/study.js?v=349',
  'modules/contentlib.js?v=349'
];
