...
const CACHE = 'xenos-cache-v9340';
const STATIC = [
  './',
  'index.html',
  'app.js?v=340',
  'styles.css?v=340',
  'fonts/zcool-sub.ttf?v=340',
  'fonts/strawberry-sub.ttf?v=340',
  'assets/mascot.png',
  'manifest.webmanifest?v=340',
  'icon-192.png?v=340',
  'modules/study.js?v=340',
  'modules/contentlib.js?v=340'
];
