...
const CACHE = 'xenos-cache-v9351';
const STATIC = [
  './',
  'index.html',
  'app.js?v=351',
  'styles.css?v=351',
  'fonts/zcool-sub.ttf?v=351',
  'fonts/strawberry-sub.ttf?v=351',
  'assets/mascot.png',
  'manifest.webmanifest?v=351',
  'icon-192.png?v=351',
  'modules/study.js?v=351',
  'modules/contentlib.js?v=351'
];
