...
const CACHE = 'xenos-cache-v9350';
const STATIC = [
  './',
  'index.html',
  'app.js?v=350',
  'styles.css?v=350',
  'fonts/zcool-sub.ttf?v=350',
  'fonts/strawberry-sub.ttf?v=350',
  'assets/mascot.png',
  'manifest.webmanifest?v=350',
  'icon-192.png?v=350',
  'modules/study.js?v=350',
  'modules/contentlib.js?v=350'
];
