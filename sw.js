...
const CACHE = 'xenos-cache-v9389';
const STATIC = [
  './',
  'index.html',
  'app.js?v=389',
  'styles.css?v=389',
  'fonts/zcool-sub.ttf?v=389',
  'fonts/strawberry-sub.ttf?v=389',
  'assets/mascot.png',
  'manifest.webmanifest?v=389',
  'icon-192.png?v=389',
  'modules/study.js?v=389',
  'modules/contentlib.js?v=389'
];
