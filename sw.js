...
const CACHE = 'xenos-cache-v9412';
const STATIC = [
  './',
  'index.html',
  'app.js?v=412',
  'styles.css?v=412',
  'fonts/zcool-sub.ttf?v=412',
  'fonts/strawberry-sub.ttf?v=412',
  'manifest.webmanifest?v=412',
  'icon-192.png?v=412',
  'modules/study.js?v=412',
  'modules/contentlib.js?v=412'
];
