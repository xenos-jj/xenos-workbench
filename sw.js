...
const CACHE = 'xenos-cache-v9391';
const STATIC = [
  './',
  'index.html',
  'app.js?v=391',
  'styles.css?v=391',
  'fonts/zcool-sub.ttf?v=391',
  'fonts/strawberry-sub.ttf?v=391',
  'assets/mascot.png',
  'manifest.webmanifest?v=391',
  'icon-192.png?v=391',
  'modules/study.js?v=391',
  'modules/contentlib.js?v=391'
];
