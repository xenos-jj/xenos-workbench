...
const CACHE = 'xenos-cache-v9357';
const STATIC = [
  './',
  'index.html',
  'app.js?v=357',
  'styles.css?v=357',
  'fonts/zcool-sub.ttf?v=357',
  'fonts/strawberry-sub.ttf?v=357',
  'assets/mascot.png',
  'manifest.webmanifest?v=357',
  'icon-192.png?v=357',
  'modules/study.js?v=357',
  'modules/contentlib.js?v=357'
];
