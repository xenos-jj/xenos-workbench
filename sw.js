...
const CACHE = 'xenos-cache-v9405';
const STATIC = [
  './',
  'index.html',
  'app.js?v=405',
  'styles.css?v=405',
  'fonts/zcool-sub.ttf?v=405',
  'fonts/strawberry-sub.ttf?v=405',
  'manifest.webmanifest?v=405',
  'icon-192.png?v=405',
  'modules/study.js?v=405',
  'modules/contentlib.js?v=405'
];
