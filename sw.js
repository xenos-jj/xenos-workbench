...
const CACHE = 'xenos-cache-v9408';
const STATIC = [
  './',
  'index.html',
  'app.js?v=408',
  'styles.css?v=408',
  'fonts/zcool-sub.ttf?v=408',
  'fonts/strawberry-sub.ttf?v=408',
  'manifest.webmanifest?v=408',
  'icon-192.png?v=408',
  'modules/study.js?v=408',
  'modules/contentlib.js?v=408'
];
