...
const CACHE = 'xenos-cache-v9346';
const STATIC = [
  './',
  'index.html',
  'app.js?v=346',
  'styles.css?v=346',
  'fonts/zcool-sub.ttf?v=346',
  'fonts/strawberry-sub.ttf?v=346',
  'assets/mascot.png',
  'manifest.webmanifest?v=346',
  'icon-192.png?v=346',
  'modules/study.js?v=346',
  'modules/contentlib.js?v=346'
];
