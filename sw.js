...
const CACHE = 'xenos-cache-v9354';
const STATIC = [
  './',
  'index.html',
  'app.js?v=354',
  'styles.css?v=354',
  'fonts/zcool-sub.ttf?v=354',
  'fonts/strawberry-sub.ttf?v=354',
  'assets/mascot.png',
  'manifest.webmanifest?v=354',
  'icon-192.png?v=354',
  'modules/study.js?v=354',
  'modules/contentlib.js?v=354'
];
