...
const CACHE = 'xenos-cache-v9361';
const STATIC = [
  './',
  'index.html',
  'app.js?v=361',
  'styles.css?v=361',
  'fonts/zcool-sub.ttf?v=361',
  'fonts/strawberry-sub.ttf?v=361',
  'assets/mascot.png',
  'manifest.webmanifest?v=361',
  'icon-192.png?v=361',
  'modules/study.js?v=361',
  'modules/contentlib.js?v=361'
];
