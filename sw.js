...
const CACHE = 'xenos-cache-v9362';
const STATIC = [
  './',
  'index.html',
  'app.js?v=362',
  'styles.css?v=362',
  'fonts/zcool-sub.ttf?v=362',
  'fonts/strawberry-sub.ttf?v=362',
  'assets/mascot.png',
  'manifest.webmanifest?v=362',
  'icon-192.png?v=362',
  'modules/study.js?v=362',
  'modules/contentlib.js?v=362'
];
