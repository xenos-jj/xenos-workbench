...
const CACHE = 'xenos-cache-v9404';
const STATIC = [
  './',
  'index.html',
  'app.js?v=404',
  'styles.css?v=404',
  'fonts/zcool-sub.ttf?v=404',
  'fonts/strawberry-sub.ttf?v=404',
  'manifest.webmanifest?v=404',
  'icon-192.png?v=404',
  'modules/study.js?v=404',
  'modules/contentlib.js?v=404'
];
