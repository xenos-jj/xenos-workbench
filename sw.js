...
const CACHE = 'xenos-cache-v9447';
const STATIC = [
  './',
  'index.html',
  'app.js?v=447',
  'styles.css?v=447',
  'fonts/zcool-sub.ttf?v=447',
  'fonts/strawberry-sub.ttf?v=447',
  'manifest.webmanifest?v=447',
  'icon-192.png?v=447',
  'modules/study.js?v=447',
  'modules/contentlib.js?v=447'
];
