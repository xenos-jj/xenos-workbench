...
const CACHE = 'xenos-cache-v9583';
const STATIC = [
  './',
  'index.html',
  'app.js?v=9583',
  'styles.css?v=9583',
  'fonts/zcool-sub.ttf?v=9583',
  'fonts/strawberry-sub.ttf?v=9583',
  'manifest.webmanifest?v=9583',
  'icon-192.png?v=9583',
  'modules/study.js?v=9583',
  'modules/contentlib.js?v=9583'
];
