...
const CACHE = 'xenos-cache-v9356';
const STATIC = [
  './',
  'index.html',
  'app.js?v=356',
  'styles.css?v=356',
  'fonts/zcool-sub.ttf?v=356',
  'fonts/strawberry-sub.ttf?v=356',
  'assets/mascot.png',
  'manifest.webmanifest?v=356',
  'icon-192.png?v=356',
  'modules/study.js?v=356',
  'modules/contentlib.js?v=356'
];
