...
const CACHE = 'xenos-cache-v9352';
const STATIC = [
  './',
  'index.html',
  'app.js?v=352',
  'styles.css?v=352',
  'fonts/zcool-sub.ttf?v=352',
  'fonts/strawberry-sub.ttf?v=352',
  'assets/mascot.png',
  'manifest.webmanifest?v=352',
  'icon-192.png?v=352',
  'modules/study.js?v=352',
  'modules/contentlib.js?v=352'
];
