...
const CACHE = 'xenos-cache-v9436';
const STATIC = [
  './',
  'index.html',
  'app.js?v=436',
  'styles.css?v=436',
  'fonts/zcool-sub.ttf?v=436',
  'fonts/strawberry-sub.ttf?v=436',
  'manifest.webmanifest?v=436',
  'icon-192.png?v=436',
  'modules/study.js?v=436',
  'modules/contentlib.js?v=436'
];
