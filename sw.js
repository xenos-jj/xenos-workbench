...
const CACHE = 'xenos-cache-v9398';
const STATIC = [
  './',
  'index.html',
  'app.js?v=398',
  'styles.css?v=398',
  'fonts/zcool-sub.ttf?v=398',
  'fonts/strawberry-sub.ttf?v=398',
  'manifest.webmanifest?v=398',
  'icon-192.png?v=398',
  'modules/study.js?v=398',
  'modules/contentlib.js?v=398'
];
