...
const CACHE = 'xenos-cache-v9419';
const STATIC = [
  './',
  'index.html',
  'app.js?v=419',
  'styles.css?v=419',
  'fonts/zcool-sub.ttf?v=419',
  'fonts/strawberry-sub.ttf?v=419',
  'manifest.webmanifest?v=419',
  'icon-192.png?v=419',
  'modules/study.js?v=419',
  'modules/contentlib.js?v=419'
];
