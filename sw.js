...
const CACHE = 'xenos-cache-v9589';
const STATIC = [
  './',
  'index.html',
  'app.js?v=9589',
  'styles.css?v=9589',
  'fonts/zcool-sub.ttf?v=9589',
  'fonts/strawberry-sub.ttf?v=9589',
  'manifest.webmanifest?v=9589',
  'icon-192.png?v=9589',
  'modules/study.js?v=9589',
  'modules/contentlib.js?v=9589'
];
