...
const CACHE = 'xenos-cache-v9397';
const STATIC = [
  './',
  'index.html',
  'app.js?v=397',
  'styles.css?v=397',
  'fonts/zcool-sub.ttf?v=397',
  'fonts/strawberry-sub.ttf?v=397',
  'manifest.webmanifest?v=397',
  'icon-192.png?v=397',
  'modules/study.js?v=397',
  'modules/contentlib.js?v=397'
];
