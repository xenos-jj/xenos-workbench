...
const CACHE = 'xenos-cache-v9313';
const STATIC = [
  './',
  'index.html',
  'app.js?v=313',
  'styles.css?v=313',
  'fonts/zcool-sub.ttf?v=313',
  'fonts/strawberry-sub.ttf?v=313',
  'assets/mascot.png',
  'manifest.webmanifest?v=313',
  'icon-192.png?v=313',
  'modules/study.js?v=313',
  'modules/contentlib.js?v=313'
];
