...
const CACHE = 'xenos-cache-v9345';
const STATIC = [
  './',
  'index.html',
  'app.js?v=345',
  'styles.css?v=345',
  'fonts/zcool-sub.ttf?v=345',
  'fonts/strawberry-sub.ttf?v=345',
  'assets/mascot.png',
  'manifest.webmanifest?v=345',
  'icon-192.png?v=345',
  'modules/study.js?v=345',
  'modules/contentlib.js?v=345'
];
