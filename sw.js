...
const CACHE = 'xenos-cache-v9317';
const STATIC = [
  './',
  'index.html',
  'app.js?v=317',
  'styles.css?v=317',
  'fonts/zcool-sub.ttf?v=317',
  'fonts/strawberry-sub.ttf?v=317',
  'assets/mascot.png',
  'manifest.webmanifest?v=317',
  'icon-192.png?v=317',
  'modules/study.js?v=317',
  'modules/contentlib.js?v=317'
];
