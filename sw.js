...
const CACHE = 'xenos-cache-v9526';
const STATIC = [
  './',
  'index.html',
  'app.js?v=526',
  'styles.css?v=526',
  'fonts/zcool-sub.ttf?v=526',
  'fonts/strawberry-sub.ttf?v=526',
  'manifest.webmanifest?v=526',
  'icon-192.png?v=526',
  'modules/study.js?v=526',
  'modules/contentlib.js?v=526'
];
