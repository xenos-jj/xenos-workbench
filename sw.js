...
const CACHE = 'xenos-cache-v9334';
const STATIC = [
  './',
  'index.html',
  'app.js?v=334',
  'styles.css?v=334',
  'fonts/zcool-sub.ttf?v=334',
  'fonts/strawberry-sub.ttf?v=334',
  'assets/mascot.png',
  'manifest.webmanifest?v=334',
  'icon-192.png?v=334',
  'modules/study.js?v=334',
  'modules/contentlib.js?v=334'
];
