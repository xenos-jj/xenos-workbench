...
const CACHE = 'xenos-cache-v9423';
const STATIC = [
  './',
  'index.html',
  'app.js?v=423',
  'styles.css?v=423',
  'fonts/zcool-sub.ttf?v=423',
  'fonts/strawberry-sub.ttf?v=423',
  'manifest.webmanifest?v=423',
  'icon-192.png?v=423',
  'modules/study.js?v=423',
  'modules/contentlib.js?v=423'
];
