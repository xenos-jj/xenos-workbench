...
const CACHE = 'xenos-cache-v9395';
const STATIC = [
  './',
  'index.html',
  'app.js?v=395',
  'styles.css?v=395',
  'fonts/zcool-sub.ttf?v=395',
  'fonts/strawberry-sub.ttf?v=395',
  'manifest.webmanifest?v=395',
  'icon-192.png?v=395',
  'modules/study.js?v=395',
  'modules/contentlib.js?v=395'
];
