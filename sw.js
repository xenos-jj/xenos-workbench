...
const CACHE = 'xenos-cache-v9318';
const STATIC = [
  './',
  'index.html',
  'app.js?v=318',
  'styles.css?v=318',
  'fonts/zcool-sub.ttf?v=318',
  'fonts/strawberry-sub.ttf?v=318',
  'assets/mascot.png',
  'manifest.webmanifest?v=318',
  'icon-192.png?v=318',
  'modules/study.js?v=318',
  'modules/contentlib.js?v=318'
];
