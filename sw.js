...
const CACHE = 'xenos-cache-v9359';
const STATIC = [
  './',
  'index.html',
  'app.js?v=359',
  'styles.css?v=359',
  'fonts/zcool-sub.ttf?v=359',
  'fonts/strawberry-sub.ttf?v=359',
  'assets/mascot.png',
  'manifest.webmanifest?v=359',
  'icon-192.png?v=359',
  'modules/study.js?v=359',
  'modules/contentlib.js?v=359'
];
