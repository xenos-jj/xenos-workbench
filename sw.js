...
const CACHE = 'xenos-cache-v9426';
const STATIC = [
  './',
  'index.html',
  'app.js?v=426',
  'styles.css?v=426',
  'fonts/zcool-sub.ttf?v=426',
  'fonts/strawberry-sub.ttf?v=426',
  'manifest.webmanifest?v=426',
  'icon-192.png?v=426',
  'modules/study.js?v=426',
  'modules/contentlib.js?v=426'
];
