...
const CACHE = 'xenos-cache-v9409';
const STATIC = [
  './',
  'index.html',
  'app.js?v=409',
  'styles.css?v=409',
  'fonts/zcool-sub.ttf?v=409',
  'fonts/strawberry-sub.ttf?v=409',
  'manifest.webmanifest?v=409',
  'icon-192.png?v=409',
  'modules/study.js?v=409',
  'modules/contentlib.js?v=409'
];
