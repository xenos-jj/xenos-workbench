...
const CACHE = 'xenos-cache-v9384';
const STATIC = [
  './',
  'index.html',
  'app.js?v=384',
  'styles.css?v=384',
  'fonts/zcool-sub.ttf?v=384',
  'fonts/strawberry-sub.ttf?v=384',
  'assets/mascot.png',
  'manifest.webmanifest?v=384',
  'icon-192.png?v=384',
  'modules/study.js?v=384',
  'modules/contentlib.js?v=384'
];
