...
const CACHE = 'xenos-cache-v9392';
const STATIC = [
  './',
  'index.html',
  'app.js?v=392',
  'styles.css?v=392',
  'fonts/zcool-sub.ttf?v=392',
  'fonts/strawberry-sub.ttf?v=392',
  'manifest.webmanifest?v=392',
  'icon-192.png?v=392',
  'modules/study.js?v=392',
  'modules/contentlib.js?v=392'
];
