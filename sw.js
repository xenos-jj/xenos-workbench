...
const CACHE = 'xenos-cache-v9417';
const STATIC = [
  './',
  'index.html',
  'app.js?v=417',
  'styles.css?v=417',
  'fonts/zcool-sub.ttf?v=417',
  'fonts/strawberry-sub.ttf?v=417',
  'manifest.webmanifest?v=417',
  'icon-192.png?v=417',
  'modules/study.js?v=417',
  'modules/contentlib.js?v=417'
];
