...
const CACHE = 'xenos-cache-v9394';
const STATIC = [
  './',
  'index.html',
  'app.js?v=394',
  'styles.css?v=394',
  'fonts/zcool-sub.ttf?v=394',
  'fonts/strawberry-sub.ttf?v=394',
  'manifest.webmanifest?v=394',
  'icon-192.png?v=394',
  'modules/study.js?v=394',
  'modules/contentlib.js?v=394'
];
