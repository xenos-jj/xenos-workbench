...
const CACHE = 'xenos-cache-v9396';
const STATIC = [
  './',
  'index.html',
  'app.js?v=396',
  'styles.css?v=396',
  'fonts/zcool-sub.ttf?v=396',
  'fonts/strawberry-sub.ttf?v=396',
  'manifest.webmanifest?v=396',
  'icon-192.png?v=396',
  'modules/study.js?v=396',
  'modules/contentlib.js?v=396'
];
