...
const CACHE = 'xenos-cache-v9422';
const STATIC = [
  './',
  'index.html',
  'app.js?v=422',
  'styles.css?v=422',
  'fonts/zcool-sub.ttf?v=422',
  'fonts/strawberry-sub.ttf?v=422',
  'manifest.webmanifest?v=422',
  'icon-192.png?v=422',
  'modules/study.js?v=422',
  'modules/contentlib.js?v=422'
];
