...
const CACHE = 'xenos-cache-v9449';
const STATIC = [
  './',
  'index.html',
  'app.js?v=449',
  'styles.css?v=449',
  'fonts/zcool-sub.ttf?v=449',
  'fonts/strawberry-sub.ttf?v=449',
  'manifest.webmanifest?v=449',
  'icon-192.png?v=449',
  'modules/study.js?v=449',
  'modules/contentlib.js?v=449'
];
