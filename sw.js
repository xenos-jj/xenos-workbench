...
const CACHE = 'xenos-cache-v9342';
const STATIC = [
  './',
  'index.html',
  'app.js?v=342',
  'styles.css?v=342',
  'fonts/zcool-sub.ttf?v=342',
  'fonts/strawberry-sub.ttf?v=342',
  'assets/mascot.png',
  'manifest.webmanifest?v=342',
  'icon-192.png?v=342',
  'modules/study.js?v=342',
  'modules/contentlib.js?v=342'
];
