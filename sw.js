...
const CACHE = 'xenos-cache-v9442';
const STATIC = [
  './',
  'index.html',
  'app.js?v=442',
  'styles.css?v=442',
  'fonts/zcool-sub.ttf?v=442',
  'fonts/strawberry-sub.ttf?v=442',
  'manifest.webmanifest?v=442',
  'icon-192.png?v=442',
  'modules/study.js?v=442',
  'modules/contentlib.js?v=442'
];
