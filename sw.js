...
const CACHE = 'xenos-cache-v9519';
const STATIC = [
  './',
  'index.html',
  'app.js?v=519',
  'styles.css?v=519',
  'fonts/zcool-sub.ttf?v=519',
  'fonts/strawberry-sub.ttf?v=519',
  'manifest.webmanifest?v=519',
  'icon-192.png?v=519',
  'modules/study.js?v=519',
  'modules/contentlib.js?v=519'
];
