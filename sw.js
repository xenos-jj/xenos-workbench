...
const CACHE = 'xenos-cache-v9355';
const STATIC = [
  './',
  'index.html',
  'app.js?v=355',
  'styles.css?v=355',
  'fonts/zcool-sub.ttf?v=355',
  'fonts/strawberry-sub.ttf?v=355',
  'assets/mascot.png',
  'manifest.webmanifest?v=355',
  'icon-192.png?v=355',
  'modules/study.js?v=355',
  'modules/contentlib.js?v=355'
];
