...
const CACHE = 'xenos-cache-v9457';
const STATIC = [
  './',
  'index.html',
  'app.js?v=457',
  'styles.css?v=457',
  'fonts/zcool-sub.ttf?v=457',
  'fonts/strawberry-sub.ttf?v=457',
  'manifest.webmanifest?v=457',
  'icon-192.png?v=457',
  'modules/study.js?v=457',
  'modules/contentlib.js?v=457'
];
