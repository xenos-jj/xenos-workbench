...
const CACHE = 'xenos-cache-v9353';
const STATIC = [
  './',
  'index.html',
  'app.js?v=353',
  'styles.css?v=353',
  'fonts/zcool-sub.ttf?v=353',
  'fonts/strawberry-sub.ttf?v=353',
  'assets/mascot.png',
  'manifest.webmanifest?v=353',
  'icon-192.png?v=353',
  'modules/study.js?v=353',
  'modules/contentlib.js?v=353'
];
