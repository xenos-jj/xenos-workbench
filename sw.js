...
const CACHE = 'xenos-cache-v9418';
const STATIC = [
  './',
  'index.html',
  'app.js?v=418',
  'styles.css?v=418',
  'fonts/zcool-sub.ttf?v=418',
  'fonts/strawberry-sub.ttf?v=418',
  'manifest.webmanifest?v=418',
  'icon-192.png?v=418',
  'modules/study.js?v=418',
  'modules/contentlib.js?v=418'
];
