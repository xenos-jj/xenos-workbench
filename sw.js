...
const CACHE = 'xenos-cache-v9413';
const STATIC = [
  './',
  'index.html',
  'app.js?v=413',
  'styles.css?v=413',
  'fonts/zcool-sub.ttf?v=413',
  'fonts/strawberry-sub.ttf?v=413',
  'manifest.webmanifest?v=413',
  'icon-192.png?v=413',
  'modules/study.js?v=413',
  'modules/contentlib.js?v=413'
];
