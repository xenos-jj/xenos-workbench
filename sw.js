...
const CACHE = 'xenos-cache-v9329';
const STATIC = [
  './',
  'index.html',
  'app.js?v=329',
  'styles.css?v=329',
  'fonts/zcool-sub.ttf?v=329',
  'fonts/strawberry-sub.ttf?v=329',
  'assets/mascot.png',
  'manifest.webmanifest?v=329',
  'icon-192.png?v=329',
  'modules/study.js?v=329',
  'modules/contentlib.js?v=329'
];
