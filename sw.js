...
const CACHE = 'xenos-cache-v9520';
const STATIC = [
  './',
  'index.html',
  'app.js?v=520',
  'styles.css?v=520',
  'fonts/zcool-sub.ttf?v=520',
  'fonts/strawberry-sub.ttf?v=520',
  'manifest.webmanifest?v=520',
  'icon-192.png?v=520',
  'modules/study.js?v=520',
  'modules/contentlib.js?v=520'
];
