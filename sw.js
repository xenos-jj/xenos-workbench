...
const CACHE = 'xenos-cache-v9399';
const STATIC = [
  './',
  'index.html',
  'app.js?v=399',
  'styles.css?v=399',
  'fonts/zcool-sub.ttf?v=399',
  'fonts/strawberry-sub.ttf?v=399',
  'manifest.webmanifest?v=399',
  'icon-192.png?v=399',
  'modules/study.js?v=399',
  'modules/contentlib.js?v=399'
];
