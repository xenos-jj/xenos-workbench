...
const CACHE = 'xenos-cache-v9437';
const STATIC = [
  './',
  'index.html',
  'app.js?v=437',
  'styles.css?v=437',
  'fonts/zcool-sub.ttf?v=437',
  'fonts/strawberry-sub.ttf?v=437',
  'manifest.webmanifest?v=437',
  'icon-192.png?v=437',
  'modules/study.js?v=437',
  'modules/contentlib.js?v=437'
];
