...
const CACHE = 'xenos-cache-v9360';
const STATIC = [
  './',
  'index.html',
  'app.js?v=360',
  'styles.css?v=360',
  'fonts/zcool-sub.ttf?v=360',
  'fonts/strawberry-sub.ttf?v=360',
  'assets/mascot.png',
  'manifest.webmanifest?v=360',
  'icon-192.png?v=360',
  'modules/study.js?v=360',
  'modules/contentlib.js?v=360'
];
