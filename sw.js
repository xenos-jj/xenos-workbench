...
const CACHE = 'xenos-cache-v9381';
const STATIC = [
  './',
  'index.html',
  'app.js?v=381',
  'styles.css?v=381',
  'fonts/zcool-sub.ttf?v=381',
  'fonts/strawberry-sub.ttf?v=381',
  'assets/mascot.png',
  'manifest.webmanifest?v=381',
  'icon-192.png?v=381',
  'modules/study.js?v=381',
  'modules/contentlib.js?v=381'
];
