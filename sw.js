...
const CACHE = 'xenos-cache-v9344';
const STATIC = [
  './',
  'index.html',
  'app.js?v=344',
  'styles.css?v=344',
  'fonts/zcool-sub.ttf?v=344',
  'fonts/strawberry-sub.ttf?v=344',
  'assets/mascot.png',
  'manifest.webmanifest?v=344',
  'icon-192.png?v=344',
  'modules/study.js?v=344',
  'modules/contentlib.js?v=344'
];
