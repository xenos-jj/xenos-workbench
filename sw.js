...
const CACHE = 'xenos-cache-v9416';
const STATIC = [
  './',
  'index.html',
  'app.js?v=416',
  'styles.css?v=416',
  'fonts/zcool-sub.ttf?v=416',
  'fonts/strawberry-sub.ttf?v=416',
  'manifest.webmanifest?v=416',
  'icon-192.png?v=416',
  'modules/study.js?v=416',
  'modules/contentlib.js?v=416'
];
