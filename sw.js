...
const CACHE = 'xenos-cache-v9585';
const STATIC = [
  './',
  'index.html',
  'app.js?v=9585',
  'styles.css?v=9585',
  'fonts/zcool-sub.ttf?v=9585',
  'fonts/strawberry-sub.ttf?v=9585',
  'manifest.webmanifest?v=9585',
  'icon-192.png?v=9585',
  'modules/study.js?v=9585',
  'modules/contentlib.js?v=9585'
];
