...
const CACHE = 'xenos-cache-v9319';
const STATIC = [
  './',
  'index.html',
  'app.js?v=319',
  'styles.css?v=319',
  'fonts/zcool-sub.ttf?v=319',
  'fonts/strawberry-sub.ttf?v=319',
  'assets/mascot.png',
  'manifest.webmanifest?v=319',
  'icon-192.png?v=319',
  'modules/study.js?v=319',
  'modules/contentlib.js?v=319'
];
