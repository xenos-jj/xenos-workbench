...
const CACHE = 'xenos-cache-v9382';
const STATIC = [
  './',
  'index.html',
  'app.js?v=382',
  'styles.css?v=382',
  'fonts/zcool-sub.ttf?v=382',
  'fonts/strawberry-sub.ttf?v=382',
  'assets/mascot.png',
  'manifest.webmanifest?v=382',
  'icon-192.png?v=382',
  'modules/study.js?v=382',
  'modules/contentlib.js?v=382'
];
