...
const CACHE = 'xenos-cache-v9338';
const STATIC = [
  './',
  'index.html',
  'app.js?v=338',
  'styles.css?v=338',
  'fonts/zcool-sub.ttf?v=338',
  'fonts/strawberry-sub.ttf?v=338',
  'assets/mascot.png',
  'manifest.webmanifest?v=338',
  'icon-192.png?v=338',
  'modules/study.js?v=338',
  'modules/contentlib.js?v=338'
];
