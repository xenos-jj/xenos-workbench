...
const CACHE = 'xenos-cache-v9421';
const STATIC = [
  './',
  'index.html',
  'app.js?v=421',
  'styles.css?v=421',
  'fonts/zcool-sub.ttf?v=421',
  'fonts/strawberry-sub.ttf?v=421',
  'manifest.webmanifest?v=421',
  'icon-192.png?v=421',
  'modules/study.js?v=421',
  'modules/contentlib.js?v=421'
];
