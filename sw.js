...
const CACHE = 'xenos-cache-v9415';
const STATIC = [
  './',
  'index.html',
  'app.js?v=415',
  'styles.css?v=415',
  'fonts/zcool-sub.ttf?v=415',
  'fonts/strawberry-sub.ttf?v=415',
  'manifest.webmanifest?v=415',
  'icon-192.png?v=415',
  'modules/study.js?v=415',
  'modules/contentlib.js?v=415'
];
