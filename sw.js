...
const CACHE = 'xenos-cache-v9425';
const STATIC = [
  './',
  'index.html',
  'app.js?v=425',
  'styles.css?v=425',
  'fonts/zcool-sub.ttf?v=425',
  'fonts/strawberry-sub.ttf?v=425',
  'manifest.webmanifest?v=425',
  'icon-192.png?v=425',
  'modules/study.js?v=425',
  'modules/contentlib.js?v=425'
];
