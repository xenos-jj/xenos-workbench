...
const CACHE = 'xenos-cache-v9341';
const STATIC = [
  './',
  'index.html',
  'app.js?v=341',
  'styles.css?v=341',
  'fonts/zcool-sub.ttf?v=341',
  'fonts/strawberry-sub.ttf?v=341',
  'assets/mascot.png',
  'manifest.webmanifest?v=341',
  'icon-192.png?v=341',
  'modules/study.js?v=341',
  'modules/contentlib.js?v=341'
];
