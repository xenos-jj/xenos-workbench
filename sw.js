...
const CACHE = 'xenos-cache-v9347';
const STATIC = [
  './',
  'index.html',
  'app.js?v=347',
  'styles.css?v=347',
  'fonts/zcool-sub.ttf?v=347',
  'fonts/strawberry-sub.ttf?v=347',
  'assets/mascot.png',
  'manifest.webmanifest?v=347',
  'icon-192.png?v=347',
  'modules/study.js?v=347',
  'modules/contentlib.js?v=347'
];
