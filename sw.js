...
const CACHE = 'xenos-cache-v9445';
const STATIC = [
  './',
  'index.html',
  'app.js?v=445',
  'styles.css?v=445',
  'fonts/zcool-sub.ttf?v=445',
  'fonts/strawberry-sub.ttf?v=445',
  'manifest.webmanifest?v=445',
  'icon-192.png?v=445',
  'modules/study.js?v=445',
  'modules/contentlib.js?v=445'
];
