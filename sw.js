...
const CACHE = 'xenos-cache-v9446';
const STATIC = [
  './',
  'index.html',
  'app.js?v=446',
  'styles.css?v=446',
  'fonts/zcool-sub.ttf?v=446',
  'fonts/strawberry-sub.ttf?v=446',
  'manifest.webmanifest?v=446',
  'icon-192.png?v=446',
  'modules/study.js?v=446',
  'modules/contentlib.js?v=446'
];
