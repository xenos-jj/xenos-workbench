...
const CACHE = 'xenos-cache-v9588';
const STATIC = [
  './',
  'index.html',
  'app.js?v=9588',
  'styles.css?v=9588',
  'fonts/zcool-sub.ttf?v=9588',
  'fonts/strawberry-sub.ttf?v=9588',
  'manifest.webmanifest?v=9588',
  'icon-192.png?v=9588',
  'modules/study.js?v=9588',
  'modules/contentlib.js?v=9588'
];
