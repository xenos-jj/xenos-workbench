...
const CACHE = 'xenos-cache-v9327';
const STATIC = [
  './',
  'index.html',
  'app.js?v=327',
  'styles.css?v=327',
  'fonts/zcool-sub.ttf?v=327',
  'fonts/strawberry-sub.ttf?v=327',
  'assets/mascot.png',
  'manifest.webmanifest?v=327',
  'icon-192.png?v=327',
  'modules/study.js?v=327',
  'modules/contentlib.js?v=327'
];
